  ...
  return (
    <section className="flex-1 px-4 md:px-6 pt-16 md:pt-20 pb-4 md:pb-6 flex items-end">
      <div className="relative w-full rounded-2xl overflow-hidden" style={{ height: 'calc(100vh - 80px)' }}>
        ...
        <div className="absolute inset-0 bg-[#223756]/18 mix-blend-multiply pointer-events-none" />
        <div className="absolute inset-0 bg-[#c2ac77]/8 mix-blend-soft-light pointer-events-none" />
        <div className="absolute inset-0 bg-gradient-to-t from-aurora-bg/90 via-aurora-bg/25 to-transparent pointer-events-none" />
        <div className="absolute inset-y-0 left-0 w-full md:w-3/5 bg-gradient-to-r from-aurora-bg/75 via-aurora-bg/30 to-transparent pointer-events-none" />
        ...
        <div className="relative z-10 flex h-full flex-col justify-end lg:justify-center lg:pb-20">
          <div className="w-full max-w-xl p-6 md:p-10 lg:px-12 lg:py-0">
            <p className="text-aurora-navy/50 text-[11px] md:text-xs font-medium tracking-[0.14em] uppercase mb-3 md:mb-4">
              Securitizadora de recebíveis
            </p>

            <h1
              className="text-aurora-navy font-medium tracking-[-0.04em] mb-4 md:mb-5 text-[clamp(2.125rem,1.6vw+1.5rem,3.125rem)] leading-[1.08]"
            >
            ...
            <div className="space-y-2.5 md:space-y-3 mb-6 md:mb-7 max-w-md">
              <p className="text-aurora-navy text-[clamp(1rem,0.35vw+0.9rem,1.25rem)] leading-snug font-medium">
            ...
            <Link
              to="/contato"
              className="inline-flex items-center gap-3 bg-aurora-navy text-white text-sm md:text-lg font-medium pl-6 md:pl-8 pr-2 py-2.5 md:py-3 rounded-full hover:bg-aurora-navy-dark transition-colors duration-200"
            >
              Solicitar análise
              <span className="bg-white rounded-full p-1.5 md:p-2">
                <ArrowRight className="w-4 h-4 md:w-5 md:h-5 text-aurora-navy" />
              </span>
            </Link>
          </div>

          <div className="relative w-full overflow-hidden pb-5 md:pb-6 lg:absolute lg:bottom-0 lg:left-0 lg:right-0">
            <div className="absolute inset-y-0 left-0 w-12 md:w-20 bg-gradient-to-r from-aurora-bg/90 to-transparent z-10 pointer-events-none" />
            <div className="absolute inset-y-0 right-0 w-12 md:w-20 bg-gradient-to-l from-aurora-bg/90 to-transparent z-10 pointer-events-none" />
            <style>{`
              @keyframes marquee {
            ...
            <div className="marquee-track">
              {[...badges, ...badges].map((badge, i) => (
                <span
                  key={i}
                  className="mx-5 md:mx-7 shrink-0 text-aurora-navy/55 whitespace-nowrap"
                  style={badge.style}
                >
                  {badge.name}
                </span>

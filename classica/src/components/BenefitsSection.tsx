...
export default function BenefitsSection() {
  return (
    <section id="beneficios" className="bg-aurora-bg px-4 md:px-6 py-16 md:py-24">
      <div className="max-w-[88rem] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 mb-10 md:mb-16 items-start">
          <div>
            <p className="text-aurora-navy/60 text-xs md:text-sm mb-2">Benefícios</p>
            <h2
          ...
          <p className="text-aurora-navy/70 text-xl md:text-3xl leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
          {benefits.map((benefit) => (
            <div
              key={benefit.title}
              className="rounded-2xl p-5 md:p-7 min-h-44 md:min-h-56 flex flex-col justify-between bg-aurora-surface"
            >
              <benefit.icon className="w-6 h-6 md:w-7 md:h-7 text-aurora-navy/70 mb-4 md:mb-6" />
              <div>
                <h3 className="text-aurora-navy text-base md:text-lg font-medium mb-1.5 md:mb-2" style={{ letterSpacing: '-0.02em' }}>
                  {benefit.title}
                </h3>
                <p className="text-aurora-navy/60 text-sm md:text-base leading-relaxed">{benefit.description}</p>
              </div>
            </div>
          ))}
        </div>

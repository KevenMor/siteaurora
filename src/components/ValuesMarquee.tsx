export default function ValuesMarquee() {
  return (
    <section className="bg-aurora-navy px-4 md:px-6 py-14 md:py-20">
      <div className="max-w-[88rem] mx-auto">
        <p className="text-white/90 text-xl md:text-3xl font-medium leading-snug max-w-3xl tracking-[-0.025em]">

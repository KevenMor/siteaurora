    ...
    <section className="bg-[#F5F5F5] px-6 py-24">
      <div className="max-w-[88rem] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        <div className="md:pr-12 md:pt-2">
          <p className="text-black/60 text-sm mb-2">Aurora Asset na Prática</p>
          <h2
          ...
          <ul className="mt-6 space-y-3 text-black/70 text-base">
        ...
        <div className="relative rounded-3xl overflow-hidden min-h-[720px]">
          ...
          <div className="relative z-10 p-10 md:p-12">
            ...
            <a href="#analise" className="inline-flex items-center gap-3 group">
              ...
              <span className="text-black font-medium">Solicitar análise</span>
            </a>
          </div>
        </div>
      </div>
